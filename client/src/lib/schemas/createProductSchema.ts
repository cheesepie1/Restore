...
export const createProductShcema = z.object({
    ...
    price: z.coerce.number({required_error: 'Proce is required'}).min(100, 'Price must be at least $1.00'),
...
export type createProductShcema = z.infer<typeof createProductShcema>;