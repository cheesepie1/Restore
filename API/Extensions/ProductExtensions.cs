...
public static class ProductExtensions
{
    ...
    // Sorts the product query based on the specified order.
    ...
    // Filters the product query by search term (case-insensitive, name only).
    ...
    // Filters the product query by brand(s) and type(s).
